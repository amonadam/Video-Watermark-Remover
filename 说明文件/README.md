...
1. 访问项目发布页面（待提供）
2. 下载最新版本的`视频去水印软件.exe`文件
3. 双击安装文件，按照提示完成安装
4. 安装完成后，从桌面或开始菜单启动软件
...
- 项目主页: https://github.com/your-repo/video-watermark-remover
- 问题反馈: https://github.com/your-repo/video-watermark-remover/issues
- 邮件: contact@your-domain.com
- 社交媒体: @your-social-handle

---

**版本历史**:
- v1.0.0 (2025-12-23): 初始版本发布，包含基本的视频去水印功能

**更新日志**:
- 2025-12-23: 修复中文路径问题
- 2025-12-22: 优化水印检测算法
- 2025-12-21: 添加批量处理功能
- 2025-12-20: 集成Lama修复模型
- 2025-12-19: 完成GUI界面开发
- 2025-12-18: 项目初始化
